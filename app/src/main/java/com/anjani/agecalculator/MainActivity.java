...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public  final int CURRENT_DATE=0;
    public  final int DATE_OF_BIRTH_DATE=1;
    ...
    private void setView() {
        ...
        tilError = findViewById(R.id.til_error1);
        ...
        try {
            switch (v.getId()) {
                case R.id.bt_calculate_age:
                    ...
                    break;
                case R.id.ib_tdy:
                    datePickerDialog(CURRENT_DATE);
                    break;
                case R.id.ib_dob:
                    datePickerDialog(DATE_OF_BIRTH_DATE);
                    break;
                case R.id.bt_clear:
                    clearAll();
                default:
                ...
                if (day < 0) {
                    ...
                    if(year>=0&&month>=0&&day>=0)
                    {
                    ...
                    else
                        {
                            ...
                            tilError.setEnabled(true);
                            tilError.setError("please select date of birth before the current date !!");
                            clearAll();
                           // tilError.setEnabled(false);
